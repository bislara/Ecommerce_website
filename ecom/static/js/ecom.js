    ...
    productForm.submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.added) {
                    submitSpan.html("In cart using Ajax <button type='submit' class='btn btn-warning btn-sm'>Remove?</button>")
                } else {
            ...
            success: function(data) {
                ...
                if (data.products.length > 0) {
                    ...
                    $.each(data.products, function(index, value) {
                        ...
                        cartBody.prepend("<tr><th scope=\"row\">" + i + "</th><td><a href='" + value.url + "'>" + value.name + "</a></td><td>" + newCartItemRemove.html() + "</td><td>" + value.price + "</td></tr>")
                        i--;
                    })
